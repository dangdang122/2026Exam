...
import kr.ac.kopo.jong._026exam.domain.Person;
import kr.ac.kopo.jong._026exam.domain.PersonValidator;
...
public class Chap09_03Controller {
    @Autowired
    private PersonValidator personValdator;
    ...
    protected void initBinder(WebDataBinder binder){
        binder.setValidator(personValdator);
    }
